...
<template>
  <div class="flex flex-col-reverse justify-between gap-2 md:flex-row md:items-center">
    <div class="capitalize">
      <!-- Aquí va el contenido adicional que desees mostrar -->
    </div>
    <div class="flex items-center">
      ...
      <div v-if="settingsVisible" class="absolute top-16 right-4 bg-white shadow-lg rounded-lg p-2 z-50">
        <button class="flex items-center text-gray-700 text-sm" @click="handleLogout">
          <i class="pi pi-sign-out text-lg mr-2"></i> Salir
        </button>
      </div>
